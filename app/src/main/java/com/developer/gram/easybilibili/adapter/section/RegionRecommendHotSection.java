...
import com.developer.gram.easybilibili.function.home.discover.AllAreasRankActivity;
...
public class RegionRecommendHotSection extends StatelessSection {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        itemViewHolder.mPlay.setText(NumberUtils.format(recommendBean.getPlay()));
        itemViewHolder.mReview.setText(NumberUtils.format(recommendBean.getDanmaku()));
        itemViewHolder.mCardView.setOnClickListener(
                v -> VideoDetailActivity.launch((Activity) mContext,
