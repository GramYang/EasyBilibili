...
import com.developer.gram.easybilibili.adapter.BangumiDetailsCommentAdapter;
import com.developer.gram.easybilibili.adapter.BangumiDetailsHotCommentAdapter;
import com.developer.gram.easybilibili.adapter.BangumiDetailsRecommendAdapter;
import com.developer.gram.easybilibili.adapter.BangumiDetailsSeasonsAdapter;
import com.developer.gram.easybilibili.adapter.BangumiDetailsSelectionAdapter;
...
import com.developer.gram.easybilibili.mvp.presenter.BangumiDetailsPresenter;
...
public class BangumiDetailsActivity extends BaseRefreshActivity<BangumiDetailsPresenter> implements BangumiDetailsContract.View{
    ...
    protected void loadData() {
        showProgressBar();
        mPresenter.getBangumiDetailsData();
    }

    @Override
    public void showBangumiDetails(BangumiDetailsInfo bangumiDetailsInfo) {
        result = bangumiDetailsInfo.getResult();
    }

    @Override
    public void showBangumiDetailsRecommend(List<BangumiDetailsRecommendInfo.ResultBean.ListBean> listBeans) {
        bangumiRecommends.addAll(listBeans);
    }

    @Override
    public void showBangumiDetailsComments(BangumiDetailsCommentInfo bangumiDetailsCommentInfo) {
    ...
    public void finishTask() {
        ...
        //设置番剧播放和追番数量
        mBangumiPlay.setText("播放：" + NumberUtils.format(Integer.valueOf(result.getPlay_count()))
                + "  " + "追番：" + NumberUtils.format(Integer.valueOf(result.getFavorites())));
        //设置番剧简介
    ...
    private void initSelectionRecycler() {
        ...
        mBangumiDetailsSelectionAdapter.setOnItemClickListener((position, holder) -> {
            ...
            VideoDetailActivity.launch(BangumiDetailsActivity.this,
