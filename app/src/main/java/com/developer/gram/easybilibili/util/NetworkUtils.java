...
public class NetworkUtils {
    ...
    public static final boolean isGpsEnabled() {
        LocationManager locationManager = (LocationManager) EasyBiliApp.getInstance().getSystemService(Context.LOCATION_SERVICE);
    ...
    public static final void openGPS() {
        ...
        try {
            PendingIntent.getBroadcast(EasyBiliApp.getInstance(), 0, GPSIntent, 0).send();
