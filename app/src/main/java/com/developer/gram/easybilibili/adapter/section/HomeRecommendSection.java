...
import com.developer.gram.easybilibili.function.home.discover.OriginalRankActivity;
...
public class HomeRecommendSection extends StatelessSection {
    ...
    public HomeRecommendSection(Context context, String title, String type, int liveCount, List<RecommendInfo.ResultBean.BodyBean> datas) {
        super(R.layout.item_recommend_header, R.layout.item_recommend_footer, R.layout.item_recommend_body);
