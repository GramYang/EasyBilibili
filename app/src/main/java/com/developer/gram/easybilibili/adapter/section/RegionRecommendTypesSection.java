...
import com.developer.gram.easybilibili.adapter.RegionRecommendTypesAdapter;
...
public class RegionRecommendTypesSection extends StatelessSection {
    ...
    public RegionRecommendTypesSection(Context context, int rid) {
        super(R.layout.layout_region_recommend_types, R.layout.item_section_empty);
    ...
    private void setRecyclerAdapter(TypesViewHolder typesViewHolder) {
        ...
        mAdapter.setOnItemClickListener((position, holder) -> RxBus.INSTANCE.post(position));
    }
