...
import com.developer.gram.easybilibili.mvp.presenter.VideoDetailPresenter;
import com.developer.gram.easybilibili.network.helper.UrlHelper;
import com.developer.gram.easybilibili.util.ConstantUtil;
import com.developer.gram.easybilibili.util.DisplayUtil;
...
public class VideoDetailActivity extends BaseActivity<VideoDetailPresenter> implements VideoDetailContract.View {
    ...
    protected void loadData() {
        mPresenter.getVideoDetailsData(av);
    }

    @Override
    public void showVideoDetails(VideoDetailsInfo videoDetailsInfo) {
    ...
    protected void initViews() {
        ...
        mFAB.setOnClickListener(v -> VideoPlayerActivity.launch(VideoDetailActivity.this, mVideoDetailsInfo.getPages().get(0).getCid(), mVideoDetailsInfo.getTitle()));
